...
namespace CFMStats.Classes
{
    ...
    {
        public oRosters GetPlayers(int positionGroupID, int teamID, int developmentID, int playerId, bool isRetired, bool is25AndUnder, int leagueId, bool isPendingFreeAgent)
        {
            ...
            foreach (DataRow item in ds.Tables[0].Rows)
            {
                var p = new oPlayer
                {
                    ...
                    portraitId = item.Field<int>("portraitId"),
                    presentationId = item.Field<int>("presentationId"),
                    injuryLength = item.Field<int>("injuryLength"),
                    injuryType = item.Field<int>("injuryType"),
                    age = item.Field<int>("age"),
                    birthDay = item.Field<int>("birthDay"),
                    birthMonth = item.Field<int>("birthMonth"),
                    birthYear = item.Field<int>("birthYear"),
                    college = item.Field<string>("college"),
                    ...
                    legacyScore = item.Field<int>("legacyScore"),
                    ...
                    weight = item.Field<int>("weight"),
                    yearsPro = item.Field<int>("yearsPro"),
                    durabilityGrade = item.Field<int>("durabilityGrade"),
                    intangibleGrade = item.Field<int>("intangibleGrade"),
                    physicalGrade = item.Field<int>("physicalGrade"),
                    productionGrade = item.Field<int>("productionGrade"),
                    sizeGrade = item.Field<int>("sizeGrade"),
                    ...
                    elusiveRating = item.Field<int>("elusiveRating"),
                    ...
                    routeRunRating = item.Field<int>("routeRunRating"),
                    ...
                    runStyle = item.Field<int>("runStyle"),
        ...
        public oRosters GetPlayerRatings(int positionGroupId, int teamId, int developmentId, int playerId, bool is25AndUnder, int leagueId)
        {
             var collection = new oRosters();
                var sp = new StoredProc
                {
        ...
        public bool UpdatePlayer(JSONRosters.Rosterinfolist i, int leagueId)
        {
            var sp = new StoredProc
            {
            ...
            sp.ParameterSet.Parameters.AddWithValue("@rosterId", i.rosterId); // needed
            //SP.ParameterSet.Parameters.AddWithValue("@homeState", i.homeState);
            //SP.ParameterSet.Parameters.AddWithValue("@homeTown", i.homeTown);
            ...
            sp.ParameterSet.Parameters.AddWithValue("@elusiveRating", i.elusiveRating);
