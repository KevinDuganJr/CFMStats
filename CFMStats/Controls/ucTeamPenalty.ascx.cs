...
{
    public partial class ucTeamPenalty : System.Web.UI.UserControl
    {
        ...
        {
            tblTenaltyStats.InnerHtml = string.Empty;

            StoredProc SP = new StoredProc();
            SP.Name = "TeamPenalty_select";
            ...
            sbTable.Append("<table id='tableStats' class='tablePenaltyStats tablesorter' >");
            ...
            sbTable.Append("<th data-sorter='true'>Penalties</th>");
            sbTable.Append("<th data-sorter='true'>Penalty Yds</th>");
            sbTable.Append("<th data-sorter='true'>Penalty/Game</th>");
            sbTable.Append("<th data-sorter='true'>Penalty Yds/Game</th>");
            ...
            foreach (DataRow item in ds.Tables[0].Rows)
            {
                ...
                sbTable.Append(string.Format("<td>{0}</td>", item.Field<int>("penalties")));
                sbTable.Append(string.Format("<td>{0:n0}</td>", item.Field<int>("penaltyYds")));
                sbTable.Append(string.Format("<td>{0}</td>", Helper.GetAverage(item.Field<int>("penalties"), item.Field<int>("games"))));
                sbTable.Append(string.Format("<td>{0}</td>", Helper.GetAverage(item.Field<int>("penaltyYds"), item.Field<int>("games"))));
            ...
            tblTenaltyStats.InnerHtml = sbTable.ToString();
        }
