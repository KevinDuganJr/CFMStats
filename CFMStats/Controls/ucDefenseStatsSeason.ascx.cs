...
{
    public partial class ucDefenseStatsSeason : System.Web.UI.UserControl
    {
        #region Properties
        ...
        protected void BuildTable(int stageIndex, int intPlayerID)
        {
            ...
            SP.Name = "StatsDefenseBySeason_select";
            ...
            sbTable.Append("<th data-filter='false' data-sorter='true'>Sacks</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>Tackles</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>FF</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>FR</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>Safety</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>TD's</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>INT</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>INT Yds</th>");
            sbTable.Append("<th data-filter='false' data-sorter='true'>Catches Allowed</th>"); 
            sbTable.Append("<th data-filter='false' data-sorter='true'>Deflections</th>");
