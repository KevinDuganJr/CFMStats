...
{
    public partial class ucRecordDefenseStats : System.Web.UI.UserControl
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            Fetch(LeagueId, Duration, "Fumbles");
        ...
        private void Fetch(int leagueId, string duration, string category)
        {
            ...
            switch (category)
            {
                ...
                case "Fumbles":
                    tableFumbles.InnerHtml = string.Empty;
                    break;
            ...
            foreach (DataRow item in ds.Tables[0].Rows)
            {
                ...
                if (category == "Sacks")
                {
                    sbTable.Append($"<td>{Helper.DoubleNull(item[category])}</td>");
                }
                else
                {
            ...
            switch (category)
            {
                ...
                case "Fumbles":
                    tableFumbles.InnerHtml = sbTable.ToString();
                    break;
