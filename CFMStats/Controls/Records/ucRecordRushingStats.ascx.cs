...
{
    public partial class ucRecordRushingStats : System.Web.UI.UserControl
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            Fetch(LeagueId, Duration, "BrokenTackles");
        ...
        private void Fetch(int leagueId, string duration, string category)
        {
            ...
            switch (category)
            {
                ...
                case "BrokenTackles":
                    tableBrokenTackles.InnerHtml = string.Empty;
                    break;
            ...
            switch (category)
            {
                ...
                case "BrokenTackles":
                    tableBrokenTackles.InnerHtml = sbTable.ToString();
                    break;
