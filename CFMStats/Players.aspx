<%@ Page Title="Players" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Players.aspx.cs" Inherits="CFMStats.Players" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <style>
        .ChkBoxClass { font-weight: bold; }
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-3 col-lg-3">
            <asp:DropDownList ID="ddlLeagueTeams" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlPositionGroup_SelectedIndexChanged"></asp:DropDownList>
        </div>
        ...
        <div class="col-xs-6 col-sm-3 col-lg-3">
            ...
            <div class="input-group input-group-sm">
                ...
                <asp:DropDownList ID="ddlDevelopment" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlPositionGroup_SelectedIndexChanged"></asp:DropDownList>
            </div>
        </div>
        ...
        <div class="col-xs-6 col-sm-3 col-lg-3">
            <table>
                <tr>
                    <td>
                        <asp:CheckBox ID="chkTwentyFiveAndUnder" CssClass="ChkBoxClass" ToolTip="25 & Under" AutoPostBack="true" runat="server" Text="" OnCheckedChanged="ddlPositionGroup_SelectedIndexChanged"/>
                    </td>
                    <td>
                        <div class="ChkBoxClass">25 & Under</div>
                    </td>
                    
                    <td style="padding-left: 15px;">
                        <a href="#" id="reset-link" class="btn btn-default btn-sm" data-toggle="tooltip" title="Reset Sorting">
        ...
        <div class="col-sm-12">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="chkTwentyFiveAndUnder" EventName="CheckedChanged"/>
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    will return Normal, Star, Superstar and Superstar X Factor players<br/>

                    <h3>
                        <strong>Star</strong>
                    </h3>
                    will return Star, Superstar and Superstar X Factor players<br/>

                    <h3>
                        <strong>Superstar</strong>
                    </h3>
                    will return Superstar and Superstar X Factor players<br/>

                    <h3>
                        <strong>Superstar X-Factor</strong>
                    </h3>
                    will return only Superstar X-Factor players<br/>
