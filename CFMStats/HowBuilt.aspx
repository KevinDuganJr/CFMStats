<%@ Page Title="How Built" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HowBuilt.aspx.cs" Inherits="CFMStats.HowBuilt" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="table-responsive table-bordered-curved">
        <div id="tableHowBuilt" runat="server" visible="true"></div>
    </div>
