<%@ Page Title="Players" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlayersSearch.aspx.cs" Inherits="CFMStats.PlayersSearch" %>
        ...
        <div class="col-lg-3 col-sm-6 mb-3">
            <table style="background-color: transparent;">
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chkOnPracticeSquad" CssClass="ChkBoxClass" ToolTip="On Practice Squad" AutoPostBack="true" runat="server" Text="" OnCheckedChanged="ddlPositionGroup_SelectedIndexChanged" />
                    </td>
                    <td>
                        <div class="ChkBoxClass">P-Squad</div>
                    </td>

                    <td>
                        <asp:CheckBox ID="chkShowOnlyRookies" CssClass="ChkBoxClass" ToolTip="Rookies Only" AutoPostBack="true" runat="server" Text="" OnCheckedChanged="ddlPositionGroup_SelectedIndexChanged" />
                    </td>
                    <td>
                        <div class="ChkBoxClass">Rookies</div>
                    </td>
